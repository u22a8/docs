...
A **trait** is a single axis of judgment: one question a model asks of content, such as "how clear is this?" or "is this on topic?" A [model](/concepts/models) has one or more traits, and scoring returns one score per trait alongside a [composite](/concepts/composite).
